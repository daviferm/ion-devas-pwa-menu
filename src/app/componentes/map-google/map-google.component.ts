...
export class MapGoogleComponent implements OnInit {
  ...
  // keyMap = environment.mapApiGoogle;
  ...
  constructor( private httpClient: HttpClient,
               public polygonService: MapPolygonService,
    ...
    // this.apiLoaded = httpClient.jsonp(`https://maps.googleapis.com/maps/api/js?key=${this.keyMap}`, 'callback')
    //     .pipe(
    //       map(() => true),
    //       catchError(() => of(false)),
    //     );
